...
st.markdown('<p style="font-size:80%;style="color:red;">প্রিয় গ্রাহক, আপনার প্যাকের মেয়াদ শীঘ্রই শেষ হয়ে যাবে, আরও আকর্ষণীয়  অফার পেতে ডায়াল *০#</p>', unsafe_allow_html=True)
