...
st.markdown('<p style="font-size:250%;">বর্তমানে ফায়ার সার্ভিস ও সিভিল ডিফেন্স এর নতুন হটলাইন নম্বর ১০২। ১৬১৬৩ হটলাইন নম্বরটি ০১লা জানুয়ারি ২০২৫ খ্রিঃ হতে অকার্যকর থাকবে।</p>', unsafe_allow_html=True)
st.markdown('<p style="font-size:160%;">ক্লিয়ারেন্স সেল!  DEEN জিন্সে ফ্ল্যাট 30% ছাড়! ভিজিট deencommerce.com</p>', unsafe_allow_html=True)
