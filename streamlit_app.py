...
st.markdown('<h5>জরুরি মুহূর্তে ১০০ টাকা পর্যন্ত ঝটপট ব্যালেন্স লোন পেতে ডায়াল *123*007# </h5>', unsafe_allow_html=True)
st.markdown('<h6>NOVOAIR-এ ব্র্যাক ব্যাংক কার্ডে ১০% ছাড়!  tinyurl.com/bblnvai</h6>', unsafe_allow_html=True)
