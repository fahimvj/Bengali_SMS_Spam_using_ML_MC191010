...
st.markdown('<p>জরুরি মুহূর্তে ১০০ টাকা পর্যন্ত ঝটপট ব্যালেন্স লোন পেতে ডায়াল *123*007#', unsafe_allow_html=True)
st.markdown('<p>NOVOAIR-এ ব্র্যাক ব্যাংক কার্ডে ১০% ছাড়!  tinyurl.com/bblnvai</p>', unsafe_allow_html=True)
st.markdown('<p>স্ট্যানচার্ট সিগনেচার ও প্ল্যাটিনাম ক্রেডিট এবং প্রায়োরিটি ডেবিট কার্ড ব্যবহারে Levi's ফ্ল্যাগশিপ স্টোরে ১০% ছাড়। বিশদ: 01324244997</p>', unsafe_allow_html=True)
st.markdown('<p>PayGo ইন্টারনেট সীমা অতিক্রম করেছে। নতুন ইন্টারনেট প্যাক কিনতে *121*3# ডায়াল করুন অথবা ক্লিক bit.ly/pay-g0</p>', unsafe_allow_html=True)
st.markdown('<p>(Chaldal) ফজলি🥭৳১০৯  হাড়িভাঙ্গা আম৳১৩০ 🎁কোডঃU4 T&C chdl.co/jdd4xjzHx</p>', unsafe_allow_html=True)
st.markdown('<p>বর্তমানে ফায়ার সার্ভিস ও সিভিল ডিফেন্স এর নতুন হটলাইন নম্বর ১০২। ১৬১৬৩ হটলাইন নম্বরটি ০১লা জানুয়ারি ২০২৫ খ্রিঃ হতে অকার্যকর থাকবে।</p>', unsafe_allow_html=True)
st.markdown('<p>ক্লিয়ারেন্স সেল!  DEEN জিন্সে ফ্ল্যাট 30% ছাড়! ভিজিট deencommerce.com</p>', unsafe_allow_html=True)
st.markdown('<p>প্রিয় গ্রাহক, আপনার প্যাকের মেয়াদ শীঘ্রই শেষ হয়ে যাবে, আরও আকর্ষণীয়  অফার পেতে ডায়াল *০#</p>', unsafe_allow_html=True)
